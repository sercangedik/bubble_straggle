...
public class BubbleStraggle extends ApplicationAdapter {
	...
	/*
	 * Ekran cizilmeden once olusturulan nesneler ve yuklenen ekranlar bu
	 * fonksiyonda bulunur.
	 */
	@Override
	public void create() {
	...
	/*
	 * Ekranin animasyonu esnasinda gerceklesen ve oyun sirasinda olan her sey
	 * bu fonksiyonda gerceklesir.
	 */
	@Override
	public void render() {
		...
		/*
		 * render esnasinda olan olaylar bu fonksiyonda cagirilir. ornek :
		 * klavyenin dinlenmesi, ekranin dinlenmesi, texture'larin cizilmesi
		 * gibi.
		 */
		GameManager.renderGame(batch);

		/*
		 * oyuncunun saga ve sola hareketlerinde gerceklesen animasyonlar ve
		 * olaylar bu fonksiyonda kontrol edilir
		 */
